...
// Composant PDF pour un seul enregistrement de pompage
const SinglePumpingRecordPDF = ({ record }) => {
  if (!record) return null;
  
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <Text style={styles.header}>Détails de l'enregistrement de pompage</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.grid}>
            ...
            <View style={styles.column}>
              <Text style={styles.label}>Date de pompage</Text>
              <Text style={styles.value}>{format(new Date(record.pumping_date), 'dd/MM/yyyy', { locale: fr })}</Text>
            </View>
            <View style={styles.column}>
        ...
        {/* Section des détails de pompage */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Détails du pompage</Text>
          <View style={styles.grid}>
            <View style={styles.column}>
            ...
            <View style={styles.column}>
              <Text style={styles.label}>Volume pompé (m³)</Text>
              <Text style={styles.value}>{record.volume_pumped || 'N/A'}</Text>
            </View>
            <View style={styles.column}>
              <Text style={styles.label}>Durée de pompage</Text>
              <Text style={styles.value}>{formatDuration(record.pumping_duration)}</Text>
            </View>
          </View>
        </View>
...
export default SinglePumpingRecordPDF;