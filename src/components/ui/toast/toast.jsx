...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed right-4 bottom-4 z-[100] flex max-h-screen flex-col-reverse gap-2", // Modifié
      className
    )}
    {...props}
  />
...
const Toast = React.forwardRef(({ className, variant, ...props }, ref) => (
  <ToastPrimitives.Root
    ref={ref}
    className={cn(
      "bg-[#2081E2] text-white rounded-lg shadow-lg p-4 min-w-[300px]", // Modifié
      variant === "destructive" && "bg-red-700 border-red-200",
      className
    )}
    {...props}
  />
